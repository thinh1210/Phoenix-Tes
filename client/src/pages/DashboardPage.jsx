...
import { LogOut, Upload, Package, Clock, Link as LinkIcon, Plus, ChevronLeft, ChevronRight, FileCode2 } from 'lucide-react';
                        ...
                        <div className="lg:col-span-1 space-y-2">
                            ...
                            {projects.map((p) => (
                                ...
                                >
                                    ...
                                    <ChevronRight className={`h-4 w-4 opacity-50 group-hover:opacity-100 ${selectedProjectId === p.id ? 'text-white opacity-100' : ''}`} />
                                </button>
                            ))}
                        </div>
